            ...
            >
              ...
              >
                <div className={style.popoverDiv + " popoverDiv"}>
                  <div className="poptitle z-10" style={{fontWeight:700, fontSize:'16px'}}>Category Filters:</div>
                  <div
                    className="relative grid gap-[12px] bg-white p-[12px] lg:grid-cols-2"
                    style={{ display: "flex", flexDirection: "column" }}
                  >
                    <div className={style.selectOne + " selectone"}>Sport Type</div>
                    ...
                    {filterData.map((item: any) => (
                      ...
                      >
                        <input
                          type="radio"
                          id={item?.name}
                          name="singleSelectGroup" // Common name attribute for single-select group
